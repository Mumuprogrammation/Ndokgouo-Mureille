...
const vege = require('../assets/images/choux2.jpg');
const dairi = require('../assets/images/lait2.jpg')
const meat = require('../assets/images/viande.jpg')
const fish = require('../assets/images/pois.jpg')
const pan = require('../assets/images/panier.jpg')
const betera = require('../assets/images/beterave.jpg')
const next = require('../assets/images/suivant.png')
const broco = require('../assets/images/brocoli.jpg')
const sacvert = require('../assets/images/plastic.jpg')
const search = require('../assets/images/search.png')
// const truc = require('../assets/images/calendar.png');
const coeur = require('../assets/images/coeur.jpg')
const cV = require('../assets/images/cVert.jpg')
const aV = require('../assets/images/aVert.jpg')
const dernierSlides = [
    {
        type: 'view',
        content: (
